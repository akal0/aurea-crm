...
import { DomainsTable } from "@/features/email-domains/components/domains-table";
  ...
  return (
    <div className="space-y-0">
      <div className="flex items-end justify-between gap-2 p-6 pb-6">
        <div>
          <h1 className="text-lg font-semibold text-primary">Email Domains</h1>
          <p className="text-xs text-primary/75">
            Manage custom domains for sending email campaigns
          </p>
        </div>
