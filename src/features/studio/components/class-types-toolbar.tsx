...
const sortOptions = [
  ...
  { value: "classes.asc", label: "Fewest classes" },
];

const PRIMARY_COLUMN_ID = "name";

export interface ClassTypesToolbarProps {
  search: string;
  ...
  onApplyFilters: (filters: { active: string[] }) => void;
}

export function ClassTypesToolbar({
  search,
  onSearchChange,
  selectedActive,
  sortValue,
  ...
  const hasFilters = selectedActive.length > 0;
      ...
      <div className="flex items-center gap-2 w-full">
        <div className="flex w-80 items-center bg-background transition duration-250 relative hover:bg-primary-foreground/50 rounded-lg h-8.5">
          ...
          <DropdownMenu open={filtersOpen} onOpenChange={setFiltersOpen}>
            ...
            <DropdownMenuContent
              align="end"
              className="rounded-lg border border-black/10 dark:border-white/5 w-[240px] p-1 mt-2 -mr-[9px]"
            >
              <DropdownMenuSub>
              ...
              <div className="pt-1">
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    onApplyFilters({ active: stagedActive });
