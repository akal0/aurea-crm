...
interface ClientTagsFieldProps {
  value: string[];
  onChange: (value: string[]) => void;
}

export function ClientTagsField({ value, onChange }: ClientTagsFieldProps) {
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant="outline"
          className="h-auto w-full justify-start p-2 bg-background border-border hover:bg-accent"
        >
