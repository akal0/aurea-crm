...
interface Props {
  ...
  onSubmit: (values: RemoveTagFromContactFormValues) => void;
  defaultValues?: Partial<RemoveTagFromContactFormValues>;
  variables: VariableItem[];
}

export const RemoveTagFromContactDialog: React.FC<Props> = ({
  open,
  onOpenChange,
  onSubmit,
  defaultValues = {},
