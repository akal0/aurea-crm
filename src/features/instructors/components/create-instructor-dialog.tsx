...
export function CreateInstructorDialog({
  ...
  const form = useForm<CreateInstructorFormData>({
  ...
  const onSubmit = (data: CreateInstructorFormData) => {
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <FormDescription className="text-[11px] ml-1">
                At least one client method (email or phone) is required
              </FormDescription>
            </div>
            ...
            <p className="text-xs font-medium text-primary/60">Instructor Profile (optional)</p>
